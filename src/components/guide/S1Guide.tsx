...
import {
  H2, H3, H4, P, Bold, Code, Formula, Divider,
  ...
  return (
    <div style={{ height: "100%", overflowY: "auto", background: "var(--bg-base)" }}>
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "32px 32px 64px" }}>
        ...
        {/* ── Pipeline overview ── */}
        <Pipeline steps={[
          { label: "SQL String",    sub: "texto plano",          color: "#6b7280" },
          { label: "Parser",        sub: "lexer → AST",          color: "#3b82f6" },
          { label: "Optimizer",     sub: "plan físico",          color: "#8b5cf6" },
          { label: "Executor",      sub: "Volcano model",        color: "#10b981" },
          { label: "Buffer Mgr",    sub: "page pool (RAM)",      color: "#f59e0b" },
          { label: "File Mgr",      sub: "heap files (disco)",   color: "#ef4444" },
        ]} />
...
ORDER  BY e.salary DESC;`} />
        ...
        {/* ══════════════════════════════════════════════════════════
            3. EXECUTOR
        ══════════════════════════════════════════════════════════ */}
        <H2>3. Executor — Modelo Volcano / Iterator</H2>
        <P>
        ...
        <CompareCards items={[
          ...
          },
          {
            ...
            color: "#f59e0b",
            bg: "#1c1207",
            pros: ["Combina ventajas de ambos", "Lee heap en orden físico (menos random I/O)", "Combina múltiples índices con AND/OR"],
...
LIMIT  15;`} />
        ...
        {/* ══════════════════════════════════════════════════════════
            5. FILE MANAGER
        ══════════════════════════════════════════════════════════ */}
        <H2>5. File Manager — Almacenamiento Físico</H2>
        <P>
...
-- Ver el log de checkpoints en los últimos 5 min
SELECT * FROM pg_stat_bgwriter;`} />
        ...
        {/* ══════════════════════════════════════════════════════════
            7. DISCO
        ══════════════════════════════════════════════════════════ */}
        <H2>7. Latencia de Almacenamiento</H2>
        <P>
        ...
        {/* ── Resumen ── */}
        <H2>Resumen: el camino de una consulta</H2>
